...
const Review = () => {
  ...
  useEffect(() => {
    dispatch(getReviewByRooms(maPhong));
  }, []);
      ...
      <div>
        <h2 className="font-semibold text-gray-800 text-xl pb-4 flex items-center">
          ...
          <div className="ml-2">
            ...
            {reviewList.saoBinhLuan}
          </div>
          <div className="ml-2">{randomNumber(10, 100)} đánh giá</div>
        </h2>
      </div>
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    <h4 className="font-semibold text-base tracking-wide text-gray-900">
                      {review.id ? review.id.tenNguoiBinhLuan : "Unknown"}
                    </h4>
