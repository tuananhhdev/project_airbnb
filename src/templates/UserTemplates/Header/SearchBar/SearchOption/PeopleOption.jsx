...
export default function PeopleOption({ people, setPeople, handleSubmit }) {
  ...
  return (
    <div
      className={`relative rounded-full px-5 py-2  w-full h-full flex items-center sb-people ${active}`}>
      ...
      <button
        className="bg-[#FF385C] text-white rounded-full h-full space-x-2 px-5"
      ...
      {active && (
        <div
          className={`absolute w-28 h-${height} transition-all px-5 bg-white shadow-2xl sb-people-popup rounded-3xl flex items-center justify-between z-30`}
          tabIndex="0"
          autoFocus>
          <p>Khách</p>
