...
const Footer = () => {
  return (
    <div>
      <footer className=" ">
        <div className="mx-auto w-full max-w-screen-xl border-t-2 border-t-gray-300 ">
          ...
          <div className="px-4 py-6 border-t-2 border-t-gray-300 md:flex md:items-center md:justify-between">
            <span className="flex text-sm text-black sm:text-center ">
              ...
              <ul className="flex ml-10">
                ...
                <li className="mr-7 list-disc">Điều khoản</li>
                <li className="mr-6 list-disc">Sơ đồ trang web</li>
              </ul>
            </span>
            <div className="flex mt-4 sm:justify-center md:mt-0 space-x-5 rtl:space-x-reverse">
              <a
                href="#"
                className="text-black hover:text-gray-900 dark:hover:text-gray-600">
                <svg
                  className="w-4 h-4"
                  aria-hidden="true"
