      ...
      <div className="bg-gray-50 border-t fixed bottom-0 w-screen z-10  py-3 hidden md:block">
        <div className="container mx-auto px-10 flex justify-between items-center text-gray-500 ">
          <div>
            ...
            <span className="px-3 hover:underline text-black cursor-pointer">
              Quyền riêng tư
            </span>
            .
            <span className="px-3 hover:underline text-black cursor-pointer">
          ...
          <div className="text-gray-700">
            ...
            <span className="hover:underline text-black cursor-pointer px-3 font-medium">
              Tiếng Việt(VN)
            </span>
            <i className="fa fa-dollar-sign font-medium cursor-pointer"></i>
            <span className="hover:underline text-black cursor-pointer px-2 font-medium">
              USD
            </span>
            <span className="font-medium hover:underline text-black">
