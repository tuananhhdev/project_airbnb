...
const Footer = () => {
  return (
    <div className={cn("border-t mt-20 pt-5 bg-gray-100")}>
      ...
      <div className="bg-gray-50 fixed border-t bottom-0 w-screen z-10  py-3 hidden md:block">
        <div className="container mx-auto px-10 flex justify-between items-center  font-semibold">
          <div>
            <span className="font-semibold text-sm">© 2022 Airbnb, Inc.</span>
            <span className="px-3 hover:underline text-black cursor-pointer font-semibold text-sm">
              Quyền riêng tư
            </span>
            .
            <span className="px-3 hover:underline text-black cursor-pointer font-semibold text-sm">
          ...
          <div className="text-gray-700">
            ...
            <span className="hover:underline text-black cursor-pointer px-3  font-semibold text-sm">
              Tiếng Việt(VN)
            </span>
