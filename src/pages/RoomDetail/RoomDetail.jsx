...
import userImg from "../../assets/img/img.png.jfif";
    ...
    <div>
      ...
      <div className="box container mx-auto px-20">
        <div>
          ...
          <div className="flex flex-wrap justify-between items-center mt-3 mb-10">
            <div>
              <span className="text-sm font-normal tracking-widest">
                <i className="fa fa-star"></i>
                {randomNumber(1, 5)} sao
              </span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mt-5">
          ...
          <div className="hidden sm:grid sm:grid-cols-2 gap-2 ">
            ...
            <div className="hidden md:block rounded-tr-xl overflow-hidden">
              <img
                src={roomDetails?.hinhAnh}
                className="w-full h-full object-cover rounded-tr-xl overflow-hidden"
                alt=""
                style={{
                  width: "1359px",
                  height: "453px",
            ...
            <div className="hidden md:block rounded-br-xl overflow-hidden">
              <img
                src={roomDetails?.hinhAnh}
                className="w-full h-full rounded-br-xl overflow-hidden object-cover"
                alt=""
                style={{
                  width: "1359px",
                  height: "453px",
